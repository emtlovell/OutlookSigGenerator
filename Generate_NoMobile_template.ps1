<#	
	...
	===========================================================================
	.DESCRIPTION
		Generates the Template for a Signature with No Mobile Number
#>
New-Item -ItemType Directory -Force -Path C:\ITDept\OSG\
...
src="https://i.postimg.cc/V6k6x5DY/Icon.png"
id="preview-image-url" width="68" height="100"></td>
...
<tr>
<td colspan="2"
style="color: rgb(135, 123, 233); font-size: 14px; font-family: Arial,Helvetica,sans-serif;"><strong>Bretts Resume</strong></td>
</tr>
<tr>
<td
...
w:&nbsp;<a href="http://brettsresume.com/" target="_blank"
rel="noopener noreferrer" data-auth="NotApplicable"
style="color: rgb(25, 50, 65); text-decoration: none;">www.BrettsResume.com</a>&nbsp;&nbsp;</p>
<p
...
"@
$htmlnomobile | Out-File "C:\ITDept\OSG\sig_template_with_no_mobile.html"
